...
var bool bTranslucentIgnoreFOW;

var float HeightPercentageForFogOfWar;

var bool bIgnoreTranslucentDOFBucketing;

var bool bAlwaysRenderInTranslucentDOFBucketPass;

var bool bNeedsGameThreadVisibility;
 ...
 *
 *	@param bNewBlockRigidBody - The value to assign to BlockRigidBody.
 */
...
* @param OtherComponent - Another Primitive Component
...
// Export UPrimitiveComponent::execSetAcceptsStaticDecals(FFrame&, void* const)
native final function SetAcceptsStaticDecals(bool bAccepts);

// Export UPrimitiveComponent::execSetAcceptsDynamicDecals(FFrame&, void* const)
