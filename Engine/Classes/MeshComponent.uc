...
native function MaterialInterface GetAuxMaterial(int ElementIndex);             //XCOM
native function SetAuxMaterial(int ElementIndex, MaterialInterface AuxMaterial); //XCOM
