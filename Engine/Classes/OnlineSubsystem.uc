...
//XCOM related
struct native SaveGameHeader
{
    var int VersionNumber;
    var int UncompressedSize;
    var int GameNum;
    var int SaveID;
    var int SaveDataCRC;
    var string Description;
    var string Time;
    var string MapCommand;
    var string DLCPacks;
    var string Language;
    var bool bIsTacticalSave;
    var bool bIsIronman;
    var bool bIsAutosave;
    var bool bIsQuicksave;
};
struct native OnlineSaveGameDataMapping
{
    var string InternalFileName;
    var array<byte> SaveGameData;
    var SaveGameHeader SaveGameHeader;
    var EOnlineEnumerationReadState ReadWriteState;
};
struct native OnlineSaveGame extends OnlineContent
{
    var init array<init OnlineSaveGameDataMapping> SaveGames;
