 ...
 *
 *  @param LocPlay - The LocalPlayer that owns this movie
 */
 ...
 *
 * @param bRequestedBlurState - What should the blur state for this scene be
 * @param bRequestedHiddenState - What should the visibility for this scene be
 */
 ...
 *
 * @param bRemoveEffect - will be true if we want to remove the effect
 */
